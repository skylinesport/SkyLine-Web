  ...
  return (
    <section className="py-24 px-4 md:px-8 lg:px-16 border-t border-border">
      <div className="container mx-auto">
        ...
        {/* Features Grid */}
        {/* Features Grid - Hover effects only */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group p-8 rounded-2xl border border-border hover:border-primary/50 hover:bg-muted/30 transition-all duration-200"
            >
              ...
              <h3 className="text-xl font-bold mb-3 group-hover:gold-text transition-colors duration-200">
                {feature.title}
              </h3>
