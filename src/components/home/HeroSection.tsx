    ...
    <section className="min-h-[90vh] flex flex-col justify-center px-4 md:px-8 lg:px-16 pt-24">
      <div className="container mx-auto">
        ...
        >
          <Link 
            to="/auth" 
            className="flex-1 py-4 px-8 text-center font-medium hover:bg-muted/50 transition-colors border-b md:border-b-0 md:border-r border-border"
          >
            About & Features
          </Link>
          <Link 
          ...
          <Link 
            ...
            className="flex-1 py-4 px-8 text-center font-medium hover:bg-muted/50 transition-colors"
          >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              {['Sports', 'Arts', 'Volunteering', 'Leadership'].map((tag) => (
                <span 
                  key={tag}
                  className="px-5 py-2 border border-border rounded-full text-sm font-medium hover:bg-muted/50 transition-colors cursor-default"
                >
                  {tag}
                </span>
              ))}
          ...
          >
            <Link to={user ? "/dashboard" : "/auth?mode=signup"} className="block group">
              <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 via-primary/10 to-transparent border border-primary/30 aspect-[4/3]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-end justify-between">
                    <div>
                      <h3 className="text-2xl font-bold group-hover:gold-text transition-all">
                        Start Tracking
                      </h3>
